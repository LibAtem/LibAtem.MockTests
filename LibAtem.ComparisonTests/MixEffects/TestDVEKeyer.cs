...
namespace LibAtem.ComparisonTests.MixEffects
{
    ...
    public class TestDVEKeyer : MixEffectsTestBase
    {
        ...
        private abstract class DVEKeyerTestDefinition<T> : TestDefinitionBase<MixEffectKeyDVESetCommand, T>
        {
            ...
            public DVEKeyerTestDefinition(AtemComparisonHelper helper, Tuple<MixEffectBlockId, UpstreamKeyId, IBMDSwitcherKeyDVEParameters> key) : base(helper, key.Item1 != MixEffectBlockId.One || key.Item2 != UpstreamKeyId.One)
            {
                _meId = key.Item1;
                _keyId = key.Item2;
                _sdk = key.Item3;
            ...
            {
                yield return $"MixEffects.{_meId:D}.Keyers.{_keyId:D}.DVE";
            }
        }
